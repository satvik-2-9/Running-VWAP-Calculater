...
from parser import stock_directory_message, add_order_no_mpid, order_executed_message, order_executed_price_message, order_cancel_message, order_delete_message, order_replace_message, trade_message, cross_trade_message, broken_trade_execution_message
...
if __name__=='__main__':
    ...
    print('Used time:',int(time()-start_time))
